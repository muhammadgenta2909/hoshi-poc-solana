...
/**
 * Isi Pack Details, TANPA pembungkus panel — dipakai panel samping desktop dan
 * sheet mobile di /open-packs. Lihat catatan yang sama di SelectPackPanel.
 */
export function PackDetailsBody({ pack }: { pack: Pack }) {
  return (
