  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col bg-[#181507] p-3.5">
        {/* grade / language / era badges — hanya yang benar-benar diketahui.
            Badge kosong dulu tak mungkin muncul karena field-field ini selalu
            terisi nilai default; sekarang atribut yang tidak diketahui memang
            disimpan kosong, jadi badge-nya ikut hilang alih-alih memajang
            "English"/"Classic" yang tak pernah dinyatakan siapa pun. */}
